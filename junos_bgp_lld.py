...
def main():
    ...
    parser.add_argument('-mi', '--macidx', default='{#PEERADDR}', help="Index macros name, default name {#SNMPVALUE}")
    parser.add_argument('-o', '--oid', nargs='*',
                        default=['.1.3.6.1.4.1.2636.5.1.1.2.1.1.1.14', '.1.3.6.1.4.1.2636.5.1.1.2.1.1.1.10',
                                 '.1.3.6.1.4.1.2636.5.1.1.2.1.1.1.13', '.1.3.6.1.4.1.2636.5.1.1.2.1.1.1.2'],
                        help="An OID that is used for snmpwalking")
    parser.add_argument('-m', '--macro', nargs='*', default=['{#PREFXTBL}', '{#ADDRTYPE}', '{#ASNUM}', '{#STATE}'],
